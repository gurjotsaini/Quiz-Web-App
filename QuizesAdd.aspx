<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuizesAdd.aspx.cs" Inherits="QuizesAdd" %>
            ...
            <div id="mainD">
                ...
                <div style="width: 80%; float: left; height: 643px; background-color: lightskyblue;">
                    ...
                    <h4 style="text-align:right">
                        <asp:Button ID="btnQuizSubmit" Text="Submit" runat="server" onclick="btnQuizSubmit_Click" style=" top:50%; left:50%; margin-right:32%; margin-top:0px; background-color:lightskyblue; border-color:lightskyblue"/>
                    </h4>
