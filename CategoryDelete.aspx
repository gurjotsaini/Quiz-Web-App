<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CategoryDelete.aspx.cs" Inherits="CategoryDelete" %>
        ...
        <form id="form1" runat="server">
            <div id="mainD">
                ...
                <div style="width: 80%; float: left; height: 643px; background-color: lightskyblue;">
                    <div id="divDeleteCategories" runat="server" style="color:white;width:100% ;text-align:center;"><h2>Delete Categories</h2></div>
                    ...
                    <h4 style="text-align:right">
                        <asp:Button ID="btnDeleteCategorySubmit" Text="Submit" runat="server" onclick="btnDeleteCategorySubmit_Click" style=" top:50%; left:50%; margin-right:32%; margin-top:0px; background-color:lightskyblue; border-color:lightskyblue"/>
                    </h4>
