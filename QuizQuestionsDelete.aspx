<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuizQuestionsDelete.aspx.cs" Inherits="QuizQuestionsDelete" %>
        ...
        <form id="form1" runat="server">
            <div id="mainD">
                ...
                <div style="width: 80%; float: left; height: 643px; background-color: lightskyblue;">
                    <div id="divDeleteQuizQuestions" runat="server" style="color:white;width:100% ;text-align:center;"><h2>Delete Quiz Question</h2></div>
                    ...
                    <h4 style="text-align:right">
                        <asp:Button ID="btnDeleteQuizQuestionSubmit" Text="Delete" runat="server" onclick="btnDeleteQuizQuestionSubmit_Click" style=" top:50%; left:50%; margin-right:32%; margin-top:0px; background-color:lightskyblue; border-color:lightskyblue"/>
                    </h4>
