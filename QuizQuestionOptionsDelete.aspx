<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuizQuestionOptionsDelete.aspx.cs" Inherits="QuizQuestionOptionsDelete" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        <title>Delete Quiz Question Option</title>
    </head>
        ...
        <form id="form1" runat="server">
            <div id="mainD">
                ...
                <div style="width: 80%; float: left; height: 643px; background-color: lightskyblue;">
                    <div id="divDeleteQuizQuestionOption" runat="server" style="color:white;width:100% ;text-align:center;"><h2>Delete Quiz Question Option</h2></div>
                    ...
                    <h4 style="text-align:right">
                        <asp:Button ID="btnDeleteQuizQuestionOptionSubmit" Text="Submit" runat="server" onclick="btnDeleteQuizQuestionOptionSubmit_Click" style=" top:50%; left:50%; margin-right:32%; margin-top:0px; background-color:lightskyblue; border-color:lightskyblue"/>
                    </h4>
