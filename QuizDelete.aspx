<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuizDelete.aspx.cs" Inherits="QuizDelete" %>
        ...
        <form id="form1" runat="server">
            <div id="mainD">
                ...
                <div style="width: 80%; float: left; height: 643px; background-color: lightskyblue;">
                    <div id="divDeleteQuiz" runat="server" style="color:white;width:100% ;text-align:center;"><h2>Delete Quiz</h2></div>
                    ...
                    <h4 style="text-align:right">
                        <asp:Button ID="btnDeleteQuizSubmit" Text="Delete" runat="server" onclick="btnDeleteQuizSubmit_Click" style=" top:50%; left:50%; margin-right:32%; margin-top:0px; background-color:lightskyblue; border-color:lightskyblue"/>
                    </h4>
