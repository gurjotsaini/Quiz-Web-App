<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuizQuestionOptionsAdd.aspx.cs" Inherits="QuizQuestionOptionsAdd" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
    <head runat="server">
        <title>Add Quiz Question Options</title>
    </head>
        ...
        <form id="form1" runat="server">
            <div id="mainD">
                ...
                <div style="width: 80%; float: left; height: 643px; background-color: lightskyblue;">
                    <div id="divAddQuizes" runat="server" style="color:white;width:100% ;text-align:center;"><h2>Add Quiz Question Option</h2></div>
                    ...
                    <h4 style="text-align:right">
                        <asp:Button ID="btnQuizQuestionOptionSubmit" Text="Submit" runat="server" onclick="btnQuizQuestionOptionSubmit_Click" style=" top:50%; left:50%; margin-right:32%; margin-top:0px; background-color:lightskyblue; border-color:lightskyblue"/>
                    </h4>
